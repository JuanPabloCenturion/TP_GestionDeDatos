...
--TAREA
INSERT INTO LA_LOLA_ROTICERIA.TAREA (DESCRIPCION, TIPO_ID)
	SELECT distinct TAREA_DESCRIPCION, tip.ID
...
--TAREA_ASIGNADA
INSERT INTO LA_LOLA_ROTICERIA.TAREA_ASIGNADA (CODIGO, MECANICO_ID, TAREA_ID, TIEMPO_DE_EJECUCION_ESTIMADO, FECHA_INICIO_ESTIMADA, ORDEN_TRABAJO_ID, FECHA_INICIO_REAL, FECHA_FIN, TIEMPO_DE_EJECUCION_REAL)
	SELECT distinct 
		TAREA_CODIGO, MECANICO_NRO_LEGAJO, tarea.ID, TAREA_TIEMPO_ESTIMADO, TAREA_FECHA_INICIO_PLANIFICADO, ot.NRO, TAREA_FECHA_INICIO, TAREA_FECHA_FIN, DATEDIFF(day, TAREA_FECHA_INICIO, TAREA_FECHA_FIN)
	FROM gd_esquema.Maestra p

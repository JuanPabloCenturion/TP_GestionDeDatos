...
--MATERIAL
INSERT INTO LA_LOLA_ROTICERIA.MATERIAL (ID, NOMBRE, DESCRIPCION)
	SELECT distinct MATERIAL_COD, MATERIAL_DESCRIPCION, MATERIAL_PRECIO
	FROM gd_esquema.Maestra
	WHERE MATERIAL_COD IS NOT NULL

--TIPO_TAREA
INSERT INTO LA_LOLA_ROTICERIA.TIPO_TAREA (TIPO, DESCRIPCION)
	SELECT distinct TIPO_TAREA, TAREA_DESCRIPCION
	FROM gd_esquema.Maestra
	WHERE TIPO_TAREA IS NOT NULL order by TAREA_DESCRIPCION

	
--TAREA
INSERT INTO LA_LOLA_ROTICERIA.TAREA (NOMBRE, DESCRIPCION, TIPO_ID)
	SELECT distinct TAREA_DESCRIPCION, TAREA_DESCRIPCION, tip.ID
...
--TAREA_ASIGNADA
INSERT INTO LA_LOLA_ROTICERIA.TAREA_ASIGNADA (CODIGO, MECANICO_ID, TAREA_ID, TIEMPO_DE_EJECUCION_ESTIMADO, FECHA_INICIO_ESTIMADA, ORDEN_TRABAJO_ID, FECHA_INICIO_REAL, FECHA_FIN)
	SELECT distinct 
		TAREA_CODIGO, MECANICO_NRO_LEGAJO, tarea.ID, TAREA_TIEMPO_ESTIMADO, TAREA_FECHA_INICIO_PLANIFICADO, ot.NRO, TAREA_FECHA_INICIO, TAREA_FECHA_FIN
	FROM gd_esquema.Maestra p
